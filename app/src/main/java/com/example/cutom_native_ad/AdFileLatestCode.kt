...
//            shimmerLayout.startShimmer() // Use startShimmer() for consistency
//            adContainer6.visibility = View.GONE
//        }
//    }
//
//    private fun hideShimmer() {
//        // Check if shimmer is visible before stopping to avoid unnecessary calls
//        if (shimmerLayout.visibility == View.VISIBLE) {
//            shimmerLayout.stopShimmer() // Use stopShimmer() for consistency
